"""
Django settings for lavantes project.
...
SECRET_KEY = "django-insecure-7t_wzr6!3_ya0q7li%&)ed0ej(qjjr=oll0+7x^ru3#x(rc9h5"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*']
AUTH_USER_MODEL = 'users.CustomUser'  # Replace 'yourapp' with the actual name of your app
...
WSGI_APPLICATION = "lavantes.wsgi.application"
